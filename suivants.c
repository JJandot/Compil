...
void initialise_suivants(void){
  ...
  suivants[_listeDecVariables_][PARENTHESE_OUVRANTE] =1;
  suivants[_listeDecVariables_][FIN] = 1;

  suivants[_listeDecVariablesBis_][POINT_VIRGULE] = 1;
  suivants[_listeDecVariablesBis_][PARENTHESE_OUVRANTE] = 1;
  suivants[_listeDecVariablesBis_][FIN] = 1;
  ...
  suivants[_declarationVariable_][PARENTHESE_OUVRANTE] = 1;
  suivants[_declarationVariable_][FIN] = 1;  

  suivants[_optTailleTableau_][VIRGULE] = 1;
  suivants[_optTailleTableau_][POINT_VIRGULE] = 1;
  suivants[_optTailleTableau_][PARENTHESE_OUVRANTE] = 1;
  suivants[_optTailleTableau_][FIN] = 1;
  ...
  suivants[_instructionAffect_][INCR] = 1;
  ...
  suivants[_instructionBloc_][INCR] = 1;
  ...
  suivants[_instructionSi_][INCR] = 1;
  ...
  suivants[_instructionTantque_][INCR] = 1;
  ...
  suivants[_instructionAppel_][INCR] = 1;  
  ...
  suivants[_instructionRetour_][INCR] = 1;  
  ...
  suivants[_instructionEcriture_][INCR] = 1;
  ...
  suivants[_instructionIncr_][INCR] = 1;  
  ...
  suivants[_instructionVide_][INCR] = 1;
  ...
  //suivants[_conjonctionBis_][ET] = 1;
  ...
  //suivants[_comparaisonBis_][EGAL] = 1;
  //suivants[_comparaisonBis_][INFERIEUR] = 1; 
  ...
  //suivants[_expArithBis_][PLUS] = 1; 
  //suivants[_expArithBis_][MOINS] = 1;      
  ...
  //suivants[_termeBis_][FOIS] = 1;
  //suivants[_termeBis_][DIVISE] = 1;
