...
typedef struct n_l_instr_ n_l_instr;	//liste instruction
typedef struct n_instr_ n_instr;		//instruction
typedef struct n_exp_ n_exp;			//expression
typedef struct n_l_exp_ n_l_exp;		//liste expression
typedef struct n_var_ n_var;			//variable
typedef struct n_l_dec_ n_l_dec;		//liste declaration
typedef struct n_dec_ n_dec;			//declaration
typedef struct n_prog_ n_prog;			//programme
typedef struct n_appel_ n_appel;		//appel
